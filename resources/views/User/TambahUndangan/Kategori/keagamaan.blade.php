...
@section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('undangan') }}" class="btn btn-dark"><i class="fa fa-arrow-left"></i>
                    Kembali</a>
                <div class="ibox mt-2">
                    <div class="ibox-head">
                    ...
                    <div class="ibox-body">
                        ...
                        <form
                            action="{{ route('user-update-undangan-form', ['id' => $sampel->id, 'kategori_id' => $kategori->id]) }}?? ''"
                            ...
                            <div class="tab-content" id="form-keagamaan">
                                ...
                                <div class="tab-pane fade show active" id="pengaturan">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="fontSelect" name="font_keagamaan"
                                            onchange="changeFont()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control " name="foto_keagamaan"
                                            value="{{ $sampel->keagamaan->foto_keagamaan ?? '' }}">
                                    </div>
                                    <div class="form-group">
            ...
            allFiles.forEach((file, index) => {
                ...
                reader.onload = function(event) {
                    ...
                    removeButton.addEventListener('click', function() {
                        allform - keagamaanFiles.splice(index, 1);
                        updatePreview();
                    });
