...
<head>
    ...
    <link href="{{ asset('TemplateUndangan') }}/lib/animate/animate.min.css" rel="stylesheet">
    <link href="{{ asset('TemplateUndangan') }}/lib/lightbox/css/lightbox.min.css" rel="stylesheet">


    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('TemplateUndangan') }}/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('TemplateUndangan') }}/css/style.css" rel="stylesheet">
</head>
...
<body data-bs-spy="scroll" data-bs-target="#navBar" id="weddingHome">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3 mx-auto animated zoomIn" style="max-width: 900px;">
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4"
                                ...
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">WE ARE
                                    GETTING MARRIED</h4>
                            </div>
                            <h1 class="display-1 text-capitalize text-white mb-3">Evelyn <i
                                    class="fa fa-heart text-primary"></i> Anthony</h1>
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-5"
                                style="border-style: double;">
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">June 28
                                    2024</h4>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid position-relative py-5" id="weddingAbout">
        <div class="position-absolute" style="top: -35px; right: 0;">
            <img src="{{ asset('TemplateUndangan') }}/img/tamp-bg-1.png" class="img-fluid" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                <div class="text-end my-auto pe-4">
                                    ...
                                    <p class="text-dark mb-0" style="line-height: 30px;">Lorem Ipsum is simply dummy
                                        text of the printing and typesetting industry. Lorem Ipsum has been the
                                        industry's standard dummy
                                    </p>
                                </div>
                                <img src="{{ asset('TemplateUndangan') }}/img/bride.jpg" class="img-fluid img-border"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                <img src="{{ asset('TemplateUndangan') }}/img/Groom.jpg" class="img-fluid img-border"
                                    alt="">
    ...
    <div class="container-fluid position-relative overflow-hidden bg-secondary py-5">
        <img src="{{ asset('TemplateUndangan') }}/img/bg-flower.png" class="img-fluid position-absolute top-0"
            style="right: -15px; transform: rotate(270deg); opacity: 0.5;" alt="">
        <img src="{{ asset('TemplateUndangan') }}/img/bg-flower.png" class="img-fluid position-absolute"
            ...
            <div class="row g-5 align-items-center">
                <div class="col-xl-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="border-white bg-primary" style="border-style: double;">
                        <img src="{{ asset('TemplateUndangan') }}/img/about-1.jpg" class="img-fluid w-100"
                            alt="">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <p class="text-white fs-5 mb-4">Lorem Ipsum is simply dummy text of the printing and
                                ...
                                <div id="tab-1" class="tab-pane fade show p-0 active">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <div class="me-4">
                                                    <img src="{{ asset('TemplateUndangan') }}/img/bride.jpg"
                                                        class="img-fluid w-100 img-border" alt="">
                                                </div>
                                                <div class="text-start my-auto">
                                                    <h5 class="text-white fw-bold">Evelyn</h5>
                                                    <p class="text-white mb-3">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry.
                                                    </p>
                                                    <div class="d-flex">
                                                        <a href=""
                                                            class="btn btn-primary btn-primary-outline-0 btn-sm-square me-2"><i
                                                        ...
                                                        <a href=""
                                                            class="btn btn-primary btn-primary-outline-0 btn-sm-square me-0"><i
                                ...
                                <div id="tab-2" class="tab-pane fade show p-0">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <div class="me-4">
                                                    <img src="{{ asset('TemplateUndangan') }}/img/Groom.jpg"
                                                        class="img-fluid w-100 img-border" alt="">
                                                </div>
                                                <div class="text-start my-auto">
                        ...
                        <div class="d-flex mt-5">
                            <div class="d-flex align-items-center justify-content-center flex-shrink-0">
                                <a href="#" class="btn btn-primary btn-primary-outline-0 py-3 px-4">Read
                                    More</a>
                            </div>
            ...
            <div class="story-timeline">
                <div class="row wow fadeInUp" data-wow-delay="0.2s">
                    <div class="col-md-6 text-end border-0 border-top border-end border-secondary p-4">
                        <div class="d-inline-flex align-items-center h-100">
                            <img src="{{ asset('TemplateUndangan') }}/img/story-1.jpg"
                                class="img-fluid w-100 img-border" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                            ...
                            <p class="m-0 fs-5">Lorem elitr magna stet rebum dolores sed. Est stet labore est lorem
                                lorem at amet sea, eos tempor rebum, labore amet ipsum sea lorem, stet rebum eirmod
                ...
                <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="col-md-6 border-start border-top border-secondary p-4">
                        <div class="d-inline-flex align-items-center h-100">
                            <img src="{{ asset('TemplateUndangan') }}/img/story-2.jpg"
                                class="img-fluid w-100 img-border" alt="">
                        </div>
                    </div>
                </div>
                <div class="row wow fadeInUp" data-wow-delay="0.4s">
                    <div class="col-md-6 text-end border-end border-top border-secondary p-4 ps-0">
                        <div class="d-inline-flex align-items-center h-100">
                            <img src="{{ asset('TemplateUndangan') }}/img/story-3.jpg"
                                class="img-fluid w-100 img-border" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                ...
                <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="col-md-6 border border-end-0 border-secondary p-4">
                        <div class="d-inline-flex align-items-center h-100">
                            <img src="{{ asset('TemplateUndangan') }}/img/story-4.jpg"
                                class="img-fluid w-100 img-border" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-5 wow zoomIn" data-wow-delay="0.1s">
            <div class="wedding-date text-center bg-light p-5"
                ...
                <div class="wedding-date-content">
                    <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4"
                        style="border-style: double;">
                        <h4 class="text-dark text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">June 28, 2024
                        </h4>
                    </div>
                ...
                <div class="position-absolute"
                    ...
                    <img src="{{ asset('TemplateUndangan') }}/img/attendance-bg.png" class="img-fluid"
                        alt="">
                </div>
                <div class="position-absolute"
    ...
    <div class="container-fluid wedding-timeline bg-secondary position-relative overflow-hidden py-5"
        ...
        <div class="position-absolute" style="top: 50%; left: -100px; transform: translateY(-50%); opacity: 0.5;">
            <img src="{{ asset('TemplateUndangan') }}/img/wedding-bg.png" class="img-fluid" alt="">
        </div>
        <div class="position-absolute"
        ...
        <div class="container position-relative py-5">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-1.jpg"
                                alt="">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-2.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-3.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-4.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-5.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-6.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-7.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="gallery-item">
                        <div class="gallery-img">
                            <img class="img-fluid w-100" src="{{ asset('TemplateUndangan') }}/img/gallery-8.jpg"
                                alt="">
                            <div class="hover-style"></div>
                            <div class="search-icon">
                ...
                <div class="col-12 text-center wow fadeIn" data-wow-delay="0.2s">
                    <a class="btn btn-primary btn-primary-outline-0 py-3 px-5 me-2" href="#">View All <i
    ...
    <div class="container-fluid team position-relative py-5">
        ...
        <div class="container py-5">
            <div class="mb-5 text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                ...
                <p class="fs-5 text-dark">Lorem Ipsum is simply dummy text of the printing and typesetting Ipsum is
            ...
            <div class="row g-4">
                    ...
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/bridesmaid-1.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                <img src="{{ asset('TemplateUndangan') }}/img/team-1-bg.png" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -40px; right: -120px; transform: rotate(-30deg); z-index: 1;">
                                <img src="{{ asset('TemplateUndangan') }}/img/team-1-bg.png" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="team-social d-flex flex-column">
                            <a class="btn btn-light btn-light-outline-0 mb-2" href="#"><i
                                    class="fab fa-twitter"></i></a>
                            <a class="btn btn-light btn-light-outline-0 mb-2" href="#"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-light btn-light-outline-0 mb-2" href="#"><i
                                    class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-light btn-light-outline-0" href="#"><i
                                    class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/bridesmaid-team-2.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/bridesmaid-3.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/bridesmaid-4.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/Groomsmen-1.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/Groomsmen-2.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/Groomsmen-3.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{ asset('TemplateUndangan') }}/img/Groomsmen-4.png"
                                    class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute"
                                style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                            ...
                            <div class="row gx-4 gy-3">
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control py-3 border-0" id="Examplename"
                                ...
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control py-3 border-0" id="Examplename"
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="exampleselect" class="form-label text-dark">Number Of
                                            Guests</label>
                                        <select class="form-control bg-white text-dark py-3 border-0"
                                            id="exampleselect" placeholder="Number Of Guests">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <textarea name="text" class="form-control border-0" id="exampletextarea" cols="30" rows="5"
                ...
                <div class="row g-5 justify-content-center text-center">
                    ...
                    <div class="col-12 wow fadeIn" data-wow-delay="0.2s">
                        <div class="border-secondary" style="border-style: double;">
                            <iframe class="w-100" style="height: 450px; margin-bottom: -6px;"
            ...
            <div class="row g-5 justify-content-center">
                ...
                <div class="col-lg-4 text-center">
                    <div class="footer-item">
                        ...
                        <p class="text-white">Dolor amet sit justo amet elitr clita ipsum elitr est.Lorem ipsum dolor
                            sit amet, consectetur adipiscing elit. Nullam in tempor dui, non consectetur enim.
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            been the industry's standard dummy
                        </p>
                        <div class="btn-link d-flex justify-content-center">
                            <a href="#" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a href="#" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i
                                    class="fab fa-twitter"></i></a>
                            <a href="#" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i
                                    class="fab fa-instagram"></i></a>
                            <a href="#" class="btn btn-md-square btn-light btn-light-outline-0 me-0"><i
                                    class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 text-end">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="#" class="btn-link"><i class="fas fa-envelope text-secondary me-2"></i>
                            info@example.com</a>
                        <a href="#" class="btn-link"><i class="fas fa-phone text-secondary me-2"></i> (+012)
                            3456 7890 123</a>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('TemplateUndangan') }}/lib/wow/wow.min.js"></script>
    <script src="{{ asset('TemplateUndangan') }}/lib/easing/easing.min.js"></script>
    <script src="{{ asset('TemplateUndangan') }}/lib/waypoints/waypoints.min.js"></script>
    <script src="{{ asset('TemplateUndangan') }}/lib/lightbox/js/lightbox.min.js"></script>


    <!-- Template Javascript -->
    <script src="{{ asset('TemplateUndangan') }}/js/main.js"></script>
</body>
